  ...
  return recipe ? (
    <div className="max-w-5xl mx-auto p-4 rounded-2xl flex flex-col md:flex-row gap-6 transition-all duration-300">
      <div className="md:w-1/2 w-full flex flex-col gap-4  border p-8 rounded mb-10 relative">
        ...
        <p>
          <span className="font-bold">Instruction:</span> {recipe?.instruction}
        </p>
        <p>
      ...
      <div>
        <form
          ...
          className={`${
            theme == "dark" ? `bg-gray-900` : `placeholder-gray-500`
          } w-[40vw] flex flex-col  border p-8 rounded mb-10`}
        >
          <input
          ...
          />
          {errors.image && (
            <small className="text-red-400 pt-2">This field is required</small>
          )}
          ...
          <input
            ...
            className="border-b outline-0 p-2 mt-5"
          />
          {errors.title && (
            <small className="text-red-400 pt-2">This field is required</small>
          )}
          ...
          <textarea
            ...
            className="border-b outline-0 mt-5"
          />
          {errors.description && (
            <small className="text-red-400 pt-2">This field is required</small>
          )}
          ...
          <select
            ...
            } border-b outline-0 mt-5 p-2`}
          >
            <option value="breakfast" id="">
              breakfast
            </option>
            <option value="launch" id="">
              launch
            </option>
            <option value="supper" id="">
              supper
            </option>
          ...
          <button className="w-[50%] py-2 border rounded m-auto mt-10 font-semibold font-xl bg-blue-900">
            Update Recipe
          </button>
          <button
            onClick={DeleteHandler}
            className="w-[50%] py-2 border rounded m-auto mt-10 font-semibold font-xl bg-red-900"
          >
            Delete Recipe
          </button>
        </form>
