...
let arr = [
  {
    ...
    "profilePic": "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    "postImage": "https://images.unsplash.com/photo-1651010966858-558fb8d3cfe1?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            ...
            <div class="currStatus">
                <ul>
                   <div class="left-icons">
                     <li>${val.isLike ? '<i class="ri-heart-fill" style="color:red;"></i>' : '<i class="ri-heart-line"></i>'}</li>
